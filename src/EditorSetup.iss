...
#define MyAppName "Horizon-Next"
#define MyAppVersion "2026 0.1 Beta"
#define MyAppPublisher "Horizon"
#define MyAppURL "https://oscar-soirey.github.io/Horizon-Next/"
#define MyAppExeName "Horizon-Next-2026.0.1.exe"
#define MyAppAssocName MyAppName + " Project"
#define MyAppAssocExt ".hnp"
...
AppId={{234189DB-88EA-4632-AEB2-2963C533DEF6}
AppName={#MyAppName}
...
DefaultDirName={autopf}\Horizon-Next-2026
...
InfoBeforeFile=S:\Documents\CLionProjects\Horizon-Next\doc.md
InfoAfterFile=S:\Documents\CLionProjects\Horizon-Next\doc.md
; Uncomment the following line to run in non administrative install mode (install for current user only).
;PrivilegesRequired=lowest
OutputDir=S:\Documents\CLionProjects\Horizon-Next\build\Release
OutputBaseFilename=EditorSetup
SetupIconFile=S:\Documents\CLionProjects\Horizon-Next\icon.ico
...
[Files]
Source: "S:\Documents\CLionProjects\Horizon-Next\build\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "S:\Documents\CLionProjects\Horizon-Next\build\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
